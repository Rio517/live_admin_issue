defmodule LiveAdminIssueWeb.PostLiveTest do
  use LiveAdminIssueWeb.ConnCase

  import Phoenix.LiveViewTest
  import LiveAdminIssue.PostsFixtures

  @create_attrs %{hidden: true, tags: ["option1", "option2"], title: "some title", view: 42}
  @update_attrs %{hidden: false, tags: ["option1"], title: "some updated title", view: 43}
  @invalid_attrs %{hidden: false, tags: [], title: nil, view: nil}
